...
import static pcg.pcg_basic.pcg32_boundedrand;
import static pcg.pcg_basic.pcg32_random;
import static pcg.pcg_basic.pcg32_srandom;
 ...
 * @author G. Amador
 */
public class pcg32_global_demo {
    ...
    public static void main(String[] args) {
        ...
        if (nondeterministic_seed) {
            ...
            pcg32_srandom(Integer.toUnsignedLong(42), Integer.toUnsignedLong(54));
        }

        System.out.printf("pcg32_random:\n"
        ...
        for (round = 1; round <= rounds; ++round) {
            ...
            for (i = 0; i < 6; ++i) {
                System.out.printf(" 0x%08x", pcg32_random());
            }
            System.out.println("");
            ...
            for (i = 0; i < 65; ++i) {
                System.out.printf("%c", pcg32_boundedrand(2) != 0 ? 'H' : 'T');
            }
            System.out.println("");
            ...
            for (i = 0; i < 33; ++i) {
                System.out.printf(" %d", (int) pcg32_boundedrand(6) + 1);
            }
            System.out.println("");
